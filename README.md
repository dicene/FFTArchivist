...
- Reads basic properties related to Items, Abilities, and Poaching.
...
- Copies all relevant and modified files directly into a mod folder structured for use with Reloaded II, and generates a new ModConfig.json using the mod information you have set in Settings.
- Saving modified EXE fields to their appropriate XML/JSON patch files for use with the FF16 Mod Loader.
- Reading data directly from existing FFTIVC mods for inspecting the mods that others have created.
- Handle linkages between Override tables and the data they are overriding, and make it easier to identify and modify overrides.
...
- Stage a new mod at a different location and then optionally either copy it to your Reloaded II mods folder, or archive it in a zip or 7z for easy sharing.
